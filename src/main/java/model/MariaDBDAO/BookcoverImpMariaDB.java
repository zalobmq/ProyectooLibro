...
public class BookcoverImpMariaDB {
	 ...
	 * 
	 * @Return Booleano que devuelve verdadero si se ha borrado la portada y falso
	 ...
	 * @Param BookCover bc
	 * 
	 * @Return booleano que devuelve verdadero si se ha conseguido guardar la y
	 * falso si ha fallado
	 */
	 ...
	 * encontrado o id=-1 si la portada no se ha encontrado
	 * 
	 */
	 ...
	 * 
	 * @Return List<BookCover> con las portadas que coincidan con dicho nombre, en
